...
saveRDS(rfFit1, './rfmFit1.rds')
saveRDS(rfFit2, './rfmFit2.rds')
saveRDS(rfFit3, './rfmFit3.rds')
...
```{r}
saveRDS(rfFit2_reduced, './rfFit2_reduced.rds')
```
...
```{r}
super_model <- readRDS("./rfFit2_reduced.rds")
print(super_model)
```
...
ggplot(ComResp, aes(x=salary)) +
    geom_density(fill="#69b3a2", color="red") + 
    ggtitle("Salary - Complete survey")

ggplot(IncompleteResp, aes(x=salary)) +
    geom_density(fill="#69b3a2", color="blue") + 
    ggtitle("Salary - Incomplete survey")
...
```{r}
proportion_true/proportion_guessed
```
